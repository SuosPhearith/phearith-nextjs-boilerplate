  ...
  data: [
    {
      ...
      container_cubic: 31.25,
    },
    {
      id: 2,
      size_name: "2.0T",
      container_length: 4.8,
      container_width: 3,
      container_height: 2.8,
      container_cubic: 40.32,
    },
    {
      id: 3,
      size_name: "1.0T",
                ...
                {data.data.map((item, index) => (
                  ...
                  >
                    <tr>
                      ...
                      <td className="whitespace-nowrap px-4 py-3 text-sm">
                        <h4 className="text-gray-700 dark:text-gray-200">
                          {item.container_length} m
                        </h4>
                      </td>
                      <td className="whitespace-nowrap px-4 py-3 text-sm">
                        <h4 className="text-gray-700 dark:text-gray-200">
                          {item.container_width} m
                        </h4>
                      </td>
                      <td className="whitespace-nowrap px-4 py-3 text-sm">
                        <h4 className="text-gray-700 dark:text-gray-200">
                          {item.container_height} m
                        </h4>
                      </td>
                      <td className="whitespace-nowrap px-4 py-3 text-sm">
                        <h4 className="text-gray-700 dark:text-gray-200">
                          {item.container_cubic} m³
                        </h4>
                      </td>
                      <td className="whitespace-nowrap px-4 py-3 text-sm">
                        <h4 className="text-gray-700 dark:text-gray-200">
